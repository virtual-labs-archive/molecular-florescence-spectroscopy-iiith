...
RUN mkdir /molecular-florescence-spectroscopy-iiith

COPY src/ /molecular-florescence-spectroscopy-iiith/src

WORKDIR ./molecular-florescence-spectroscopy-iiith/src
